...
#  external_ip = "144.24.24.171"
  external_ip = var.ingress_nginx_enabled ? data.kubernetes_service.ingress_nginx_controller_service.0.status.load_balancer.ingress.0.ip : "#Ingress_Not_Deployed"
}
