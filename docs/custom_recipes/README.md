      ...
      "items": {
        "properties": {
          ...
          "recipe_mode": {
            ...
            "description": "One of the following: service, job, or shared_node_pool. Enter service for inference recipe deployments and job for fine-tuning recipe deployments."
          },
          "recipe_replica_count": {
            "type": "integer",
            "description": "Number of replicas of the recipe container pods to create. This feature is under development. Always enter 1."
          },
          "recipe_node_shape": {
            "type": "string",
            "description": "Enter the shape of the node that you want to deploy the recipe on to. Example: BM.GPU.A10.4"
          },
          "recipe_node_pool_size": {
            "type": "integer",
            "description": "Number of nodes that you want to allocate for this recipe deployment. Ensure you have sufficient capacity. This feature is under development. Always enter 1."
          },
          ...
          "recipe_image_uri": {
            "type": "string",
            "description": "Location of the recipe container image. Each recipe points to a specific container image. See the recipe.json examples below. Example: iad.ocir.io/iduyx1qnmway/corrino-devops-repository:vllmv0.6.2"
          },
          ...
          "recipe_container_command_args": {
            ...
            "description": "Container init arguments to pass. Each recipe has specific container arguments that it expects. See the Recipe Arguments section below for details. Example: [\"--model\",\"$(Model_Path)\",\"--tensor-parallel-size\",\"$(tensor_parallel_size)\"]"
          },
          "recipe_container_env": {
            ...
            "description": "Values of the recipe container init arguments. Example: [{\"key\": \"tensor_parallel_size\",\"value\": \"2\"},{\"key\": \"model_name\",\"value\": \"NousResearch/Meta-Llama-3.1-8B-Instruct\"},{\"key\": \"Model_Path\",\"value\": \"/models/NousResearch/Meta-Llama-3.1-8B-Instruct\"}]"
          },
          ...
          "recipe_container_port": {
            "type": "string",
            "description": "Required for inference recipe deployments. Inference endpoint will point to this port."
          },
          ...
          "recipe_nvidia_gpu_count": {
            "type": "integer",
            "description": "Number of GPUs within the node that you want to deploy the recipe's artifacts on to. Must be greater than 0. Must be less than the total number of GPUs available in the node shape. For example, VM.GPU.A10.2 has 2 GPUs, so this parameter cannot exceed 2 if the recipe_node_shape is VM.GPU.A10.2."
          },
          ...
          "service_endpoint_domain": {
            "type": "string",
            "description": "Required for inference recipe deployments. Inference endpoint will point to this domain."
          },
          "service_endpoint": {
            "type": "object",
            "properties": {
